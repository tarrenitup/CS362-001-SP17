...
public class CalDayRandomTest {
	private static final long TestTimeout = 60 * 500 * 10; /* Timeout at seconds */
		  	...
		  	CalDay calDay = new CalDay(cal);
				...
				for (int i = 0; i < NUM_TESTS; i++) {
					  ...
					  appt.setDescription(newDesc);
						...
						int newYear = (int) ValuesGenerator.getRandomIntBetween(random, 2017, 2020);
					  ...
					  appt0.setDescription(newDesc);
						...
						int newHour0 = (int) ValuesGenerator.getRandomIntBetween(random, -2, 25);
